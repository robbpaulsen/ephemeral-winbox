...
try {
    ...
    function InstallApps {
        ...
        -WindowStyle Normal -NoProfile -ExecutionPolicy ByPass -Command winget import --accept-package-agreements --accept-source-agreements --disable-interactivity -i $apps'
    }
    InstallApps
}
catch {
